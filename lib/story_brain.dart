...
class StoryBrain {
  ...
  String getStory() => this._storyData[storyNumber].getStoryTitle();
  String getChoice1() => this._storyData[storyNumber].getChoice1();
  String getChoice2() => this._storyData[storyNumber].getChoice2();
  ...
  bool buttonShouldBeVisible() =>
      storyNumber == 0 || storyNumber == 1 || storyNumber == 2;
}
